...
def main():
    ...
    x = db.execute("CREATE TABLE users (id serial PRIMARY KEY,username VARCHAR NOT NULL,pass VARCHAR NOT NULL);")
    db.commit()
...
#db.execute("CREATE TABLE users (id integer PRIMARY,username VARCHAR NOT NULL,pass VARCHAR NOT NULL);")
